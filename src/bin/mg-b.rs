...
const NIT: usize = 20; // for class S
const NX_DEFAULT: usize = 256;
const NY_DEFAULT: usize = 256;
const NZ_DEFAULT: usize = 256;
const NIT_DEFAULT: usize = NIT;
const LM: usize = ilog2(256) as usize;
const LT_DEFAULT: usize = LM;
const DEBUG_DEFAULT:usize = 0;
const NDIM1: usize = LM;
const NDIM2: usize = ilog2(256) as usize;
const NDIM3: usize = ilog2(256) as usize;
const ONE: usize = 1;

const NPBVERSION: &str = "4.1.2";
const COMPILETIME: &str = "2023-04-30T16:36:01.796310045-03:00";
