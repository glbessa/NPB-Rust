...
const NX_DEFAULT: usize = 512;
const NY_DEFAULT: usize = 512;
const NZ_DEFAULT: usize = 512;
const NIT_DEFAULT: usize = NIT;
const LM: usize = ilog2(512) as usize;
const LT_DEFAULT: usize = LM;
const DEBUG_DEFAULT:usize = 0;
const NDIM1: usize = LM;
const NDIM2: usize = ilog2(512) as usize;
const NDIM3: usize = ilog2(512) as usize;
const ONE: usize = 1;

const NPBVERSION: &str = "4.1.2";
const COMPILETIME: &str = "2023-04-30T16:35:44.456318864-03:00";
